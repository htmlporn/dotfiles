" vrunchbang-dark, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_8 =  '#707e82'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#3b4245'
  let g:terminal_color_11 = '#485154'
...
if filereadable(expand('~/.nightshell/vrunchbang-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/vrunchbang-dark'
  endif
endif
...
augroup NightsenseThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vrunchbang-dark | endif'
augroup END
...
cal <sid>h('Cursor'           , s:g1, s:g5 , s:t0 , s:t5 , 'none'      , ''  )
...
" line numbers
cal <sid>h('CursorLineNr'     , g:terminal_color_0 , s:g3 , s:t0 , s:t3 , 'none'      , ''  )
...
if exists('g:vrunchbang_dark_CursorLineNr')
if g:vrunchbang_dark_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:vrunchbang_dark_LineNr')
if g:vrunchbang_dark_LineNr == 'off'
